  ...
  (
    ...
    useImperativeHandle(ref, () => ({
      getCode: () => {
        ...
        // 1.Remove out selection class/atributes/ outline from all elements
        doc
    ...
    return (
      <div className="relative h-full bg-white-900 flex-1 rounded-xl overflow-hidden max-sm:ml-2">
